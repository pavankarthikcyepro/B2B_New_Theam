...
export const mainPara1 =
  "http://automatestaging-724985329.ap-south-1.elb.amazonaws.com:8091/oh/active-branches/1/146";
export const mainPara2 =
  "http://automatestaging-724985329.ap-south-1.elb.amazonaws.com:8092/sales-gap/get_employee_role/146";
export const mainPara =
  "http://automatestaging-724985329.ap-south-1.elb.amazonaws.com:8092/sales-gap/add_targetmapping_role";

const URL = {
  MAIN_PARA1: () => mainPara1,
  MAIN_PARA2: () => mainPara2,
  MAIN_PARA: () => mainPara,
