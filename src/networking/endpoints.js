...
export const hrms_url =
  "http://liveautomate-345116193.ap-south-1.elb.amazonaws.com:8088/hrms";
export const sales_url =
  "http://liveautomate-345116193.ap-south-1.elb.amazonaws.com:8081/sales";
export const roleManagement_url =
  "http://liveautomate-345116193.ap-south-1.elb.amazonaws.com:8089/role-management";
export const ops_url =
  "http://liveautomate-345116193.ap-south-1.elb.amazonaws.com:8084/ops";
export const inventory_url =
  "http://liveautomate-345116193.ap-south-1.elb.amazonaws.com:8087/inventory";
export const vehicleServices_url =
  "http://liveautomate-345116193.ap-south-1.elb.amazonaws.com:8083/vehicle-services";
export const admin_url =
  "http://liveautomate-345116193.ap-south-1.elb.amazonaws.com:8082/admin";
export const notificationServices_url =
  "http://liveautomate-345116193.ap-south-1.elb.amazonaws.com:8086/notification-service";
export const vehicleInfoService_url =
  "http://liveautomate-345116193.ap-south-1.elb.amazonaws.com:8090/vehicle-information-service";
export const customerService_url =
  "http://liveautomate-345116193.ap-south-1.elb.amazonaws.com:8085/customer-service";
export const dynamicReports_url =
  "http://liveautomate-345116193.ap-south-1.elb.amazonaws.com:8091/dynamic-reports";
export const dynamicForms =
  "http://liveautomate-345116193.ap-south-1.elb.amazonaws.com:8091/dynamic-forms";
export const orgnaizationHirarchy =
  "http://liveautomate-345116193.ap-south-1.elb.amazonaws.com:8091/oh";
export const dashboard =
  "http://liveautomate-345116193.ap-south-1.elb.amazonaws.com:8092/dashboard";
export const dfGetAll =
  "http://liveautomate-345116193.ap-south-1.elb.amazonaws.com:8091/df-get-all";
export const subSourceAllDetails =
  "http://liveautomate-345116193.ap-south-1.elb.amazonaws.com:8091/Source_SubSource_AllDetails";
...
const URL = {
  ...
  GET_PAID_ACCESSORIES_LIST: (orgId) => {
    return (
      inventory_url + `/inventory/accessories/${orgId}?pageNo=0&pageSize=1000`
    );
  },
  ...
  GET_TEST_DRIVE_DSE_LIST: () =>
    roleManagement_url + "/user/role/name/Testdrive_DSE",
