...
export const getEmployeeList = "http://liveautomate-345116193.ap-south-1.elb.amazonaws.com:8081/sales/employees/reporting/all/emp"
export const getReportingMangerList = "http://liveautomate-345116193.ap-south-1.elb.amazonaws.com:8081/sales/employees/all/reportingManagers/orgId"
export const updateEmployeeTaskDelegate = "http://liveautomate-345116193.ap-south-1.elb.amazonaws.com:8081/sales/employees/emp"
export const getLeaderBoardData = "http://liveautomate-345116193.ap-south-1.elb.amazonaws.com:8092/dashboard/v2/get_emp_target_ranking/org"
export const getBranchRankingData = "http://liveautomate-345116193.ap-south-1.elb.amazonaws.com:8092/dashboard/v2/get_emp_target_ranking"
export const deleteModelCard = "http://liveautomate-345116193.ap-south-1.elb.amazonaws.com:8081/sales/lead"
