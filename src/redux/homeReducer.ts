...
export const getUserWiseTarget = createAsyncThunk(
  "HOME/getUserWiseTarget",
  async (payload: any, { rejectWithValue }) => {
    // console.log("PAYLOAD:", payload);
...
export const homeSlice = createSlice({
 ...
 .addCase(getTotalTargetCounts.fulfilled, (state, action) => {
          ...
          .addCase(
            updateEmployeeDataBasedOnDelegate.fulfilled,
            (state, action) => {
          ...
          .addCase(
            updateEmployeeDataBasedOnDelegate.rejected,
            (state, action) => {
              state.isLoading = false;
            }
          )
