    ...
    setDropDown: (state, action) => {
      switch (action.payload) {
        ...
        case "PRIME_EXPECTATION_CAR":
          ...
          break;
        case "RETAILFINANCE":
          state.dropDownData = retailFinanceData;
          state.dropDownTitle = "Select Retail Finance";
          state.dropDownKeyId = "RETAILFINANCE";
          break;
      }
