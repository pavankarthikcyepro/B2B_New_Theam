...
export const getbookingDetailsApi = createAsyncThunk("BOONING_FORMS_SLICE/getbookingDetailsApi", async (universalId, { rejectWithValue }) => {
  ...
  try {
    ...
    console.error("getbookingDetailsApi JSON parse error: ", error + " : " + JSON.stringify(response));
    return rejectWithValue({ message: "Json parse error: " + JSON.stringify(response) });
  }
})

export const updateBookingDetailsApi = createAsyncThunk("BOONING_FORMS_SLICE/updateBookingDetailsApi", async (payload, { rejectWithValue }) => {
  ...
  try {
    ...
    console.error("updateBookingDetailsApi JSON parse error: ", error + " : " + JSON.stringify(response));
    return rejectWithValue({ message: "Json parse error: " + JSON.stringify(response) });
  }
})


export const getOnRoadPriceAndInsurenceDetailsApi = createAsyncThunk("BOONING_FORMS_SLICE/getOnRoadPriceAndInsurenceDetailsApi", async (payload, { rejectWithValue }) => {
...
export const dropBooingApi = createAsyncThunk("BOONING_FORMS_SLICE/dropBooingApi", async (payload, { rejectWithValue }) => {
  ...
  try {
    ...
    console.error("dropBooingApi JSON parse error: ", error + " : " + JSON.stringify(response));
    return rejectWithValue({ message: "Json parse error: " + JSON.stringify(response) });
  }
})

export const sendOnRoadPriceDetails = createAsyncThunk("BOONING_FORMS_SLICE/sendOnRoadPriceDetails", async (payload, { rejectWithValue }) => {
...
export const getCustomerTypesApi = createAsyncThunk("BOONING_FORMS_SLICE/getCustomerTypesApi", async (universalId, { rejectWithValue }) => {
...
export const getDropDataApi = createAsyncThunk("BOONING_FORMS_SLICE/getDropDataApi", async (payload, { rejectWithValue }) => {
...
export const getDropSubReasonDataApi = createAsyncThunk("BOONING_FORMS_SLICE/getDropSubReasonDataApi", async (payload, { rejectWithValue }) => {
...
export const getOnRoadPriceDtoListApi = createAsyncThunk("BOONING_FORMS_SLICE/getOnRoadPriceDtoListApi", async (leadId, { rejectWithValue }) => {
...
export const bookingPaymentApi = createAsyncThunk("BOONING_FORMS_SLICE/bookingPaymentApi", async (payload, { rejectWithValue }) => {
...
export const postBookingAmountApi = createAsyncThunk("BOONING_FORMS_SLICE/postBookingAmountApi", async (payload, { rejectWithValue }) => {
...
export const getPaymentDetailsApi = createAsyncThunk("BOONING_FORMS_SLICE/getPaymentDetailsApi", async (leadId, { rejectWithValue }) => {
...
export const getBookingAmountDetailsApi = createAsyncThunk("BOONING_FORMS_SLICE/getBookingAmountDetailsApi", async (leadId, { rejectWithValue }) => {
...
export const getAssignedTasksApi = createAsyncThunk("BOONING_FORMS_SLICE/getAssignedTasksApi", async (universalId, { rejectWithValue }) => {
...
const BookingFormSlice = createSlice({
  ...
  reducers: {
    clearState: (state, action) => {
      ...
      state.booking_details_response = null;
      state.customer_types_response = null;
      state.vehicle_on_road_price_insurence_details_response = null;
      state.booking_drop_response_status = null;
      state.update_booking_details_response = null;
      ...
      state.booking_payment_response = null;
      state.booking_payment_response_status = "";
  ...
  extraReducers: (builder) => {
    ...
    builder.addCase(getbookingDetailsApi.pending, (state, action) => {
      state.booking_details_response = null;
      state.isLoading = true;
    })
    builder.addCase(getbookingDetailsApi.fulfilled, (state, action) => {
      if (action.payload.dmsEntity) {
        state.booking_details_response = action.payload.dmsEntity;
      }
      state.isLoading = false;
    })
    builder.addCase(getbookingDetailsApi.rejected, (state, action) => {
      state.booking_details_response = null;
      state.isLoading = false;
    })
    // Update PreBooking Details
    builder.addCase(updateBookingDetailsApi.pending, (state, action) => {
      state.update_booking_details_response = "";
      state.isLoading = true;
    })
    builder.addCase(updateBookingDetailsApi.fulfilled, (state, action) => {
      if (action.payload.success == true) {
        state.update_booking_details_response = "success";
      }
      state.isLoading = false;
    })
    builder.addCase(updateBookingDetailsApi.rejected, (state, action) => {
      console.log("F updateBookingDetailsApi: ", JSON.stringify(action.payload));
      state.update_booking_details_response = "failed";
      state.isLoading = false;
    })
    ...
    // Drop Pre-Booking
    builder.addCase(dropBooingApi.pending, (state, action) => {
      state.booking_drop_response_status = "pending"
      state.isLoading = true;
    })
    builder.addCase(dropBooingApi.fulfilled, (state, action) => {
      if (action.payload.status === "SUCCESS") {
        state.booking_drop_response_status = "success";
      }
      state.isLoading = false;
    })
    builder.addCase(dropBooingApi.rejected, (state, action) => {
      state.booking_drop_response_status = "failed"
      state.isLoading = false;
    })
    ...
    builder.addCase(bookingPaymentApi.pending, (state, action) => {
      state.booking_payment_response = null;
      state.booking_payment_response_status = "pending";
      state.isLoading = true;
    })
    builder.addCase(bookingPaymentApi.fulfilled, (state, action) => {
      if (action.payload.success == true) {
        state.booking_payment_response = action.payload.dmsEntity;
        state.booking_payment_response_status = "success";
      }
      state.isLoading = false;
    })
    builder.addCase(bookingPaymentApi.rejected, (state, action) => {
      if (action.payload["errorMessage"]) {
        showToastRedAlert(action.payload["errorMessage"]);
      }
      state.booking_payment_response = null;
      state.booking_payment_response_status = "failed";
      state.isLoading = false;
    })
    //Post Booking Amount
