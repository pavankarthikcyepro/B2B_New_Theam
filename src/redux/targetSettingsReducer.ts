...
export const getEmployeesActiveBranch = createAsyncThunk(
  "TARGET_SETTINGS/getEmployeesActiveBranch",
  async (payload: any, { rejectWithValue }) => {
    const response = await client.get(
      URL.GET_EMPLOYEES_ACTIVE_BRANCHES(payload.orgId, payload.empId)
    );
...
export const getEmployeesRolls = createAsyncThunk(
  "TARGET_SETTINGS/getEmployeesRolls",
  async (payload: any, { rejectWithValue }) => {
...
export const addTargetMapping = createAsyncThunk(
  "TARGET_SETTINGS/addTargetMapping",
  async (payload: any, { rejectWithValue }) => {
...
export const editTargetMapping = createAsyncThunk(
  "TARGET_SETTINGS/editTargetMapping",
  async (payload: any, { rejectWithValue }) => {
...
export const getEmployeesDropDownData = createAsyncThunk(
  "TARGET_SETTINGS/getEmployeesDropDownData",
  async (payload: any, { rejectWithValue }) => {
...
export const getAllTargetMapping = createAsyncThunk(
  "TARGET_SETTINGS/getAllTargetMapping",
  async (payload: any, { rejectWithValue }) => {
...
export const getSpecialDropValue = createAsyncThunk(
  "TARGET_SETTINGS/getSpecialDropValue",
  async (payload: any, { rejectWithValue }) => {
...
export const saveSelfTargetParams = createAsyncThunk(
  "TARGET_SETTINGS/saveSelfTargetParams",
  async (payload: any, { rejectWithValue }) => {
    const response = await client.post(
      URL.UPDATE_SELF_TARGET_PARAMS(),
      payload
    );
    const json = await response.json();
    if (json?.message) {
...
export const saveTeamTargetParams = createAsyncThunk(
  "TARGET_SETTINGS/saveTeamTargetParams",
  async (payload: any, { rejectWithValue }) => {
    const response = await client.post(
      URL.UPDATE_TEAM_TARGET_PARAMS(),
      payload
    );
    const json = await response.json();
    if (json?.message) {
