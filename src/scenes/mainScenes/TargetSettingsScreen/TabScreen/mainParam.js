...
import { RenderLevel1NameView, SourceModelView } from '../../Home/TabScreens/targetScreen1';
       ...
       {false && <View>
          ...
          >
            <View>
              ...
              >
                <View style={{ width: 100, height: 20, marginRight: 5 }}></View>
                <View
                  style={{
                    width: "100%",
                    height: 20,
                          ...
                          selector.startDate === item.startDate && (
                            ...
                            >
                              ...
                              >
                                ...
                                <View
                                  style={{ width: 88, alignItems: "center" }}
                                >
                                  {Number(item.employeeId) !==
                                    Number(loggedInEmpDetails?.empId) &&
                                    selector.endDate === item.endDate &&
            ...
            >
              ...
              >
                <Dropdown
                  ...
                  value={
                    selector.isTeam ? defaultBranch : Number(defaultBranch)
                  }
