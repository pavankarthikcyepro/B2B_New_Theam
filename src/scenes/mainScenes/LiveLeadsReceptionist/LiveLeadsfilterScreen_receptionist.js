...
const LiveLeadsfilterScreen_receptionist = ({ route, navigation }) => {
  const selector = useSelector((state) => state.homeReducer);
  const dispatch = useDispatch();
  const targetSelector = useSelector((state) => state.liveLeadsReducerReceptionist);
...
export default LiveLeadsfilterScreen_receptionist;
