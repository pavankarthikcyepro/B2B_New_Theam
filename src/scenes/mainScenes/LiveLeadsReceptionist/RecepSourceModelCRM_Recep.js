...
const RecepSourceModelCRM_Recep = ({ route, navigation }) => {
  ...
  const liveLeads_selector = useSelector((state) => state.liveLeadsReducerReceptionist);
  const {
    empId,
    loggedInEmpId,
    headerTitle,
...
export default RecepSourceModelCRM_Recep;
