...
import { getUpcomingEventListApi, getMoreUpcomingEventListApi } from "../../../redux/eventManagementReducer";


const UpcomingEventListScreen = ({ navigation }) => {
  ...
  const getMoreListDataFromServer = (empId, branchId, orgId) => {
    ...
    if (empId && ((selector.pageNumber + 1) < selector.totalPages)) {
      ...
      dispatch(getMoreUpcomingEventListApi(payload));
    }
  }
...
export default UpcomingEventListScreen;
