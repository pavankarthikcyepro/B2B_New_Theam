...
let dealeid;
const TaskthreeSixtyhistoryFilter = (props) => {
    ...
    const submitBtnForEmployeeData = () => {
        ...
        // todo
        // return
        if (props.route.params.fromScreen === "TASK360_HISTORY") {
            props.navigation.navigate(EmsStackIdentifiers.task360History, {
                params: {
                    from: "Filter",
...
export default TaskthreeSixtyhistoryFilter;
