    ...
    return (
        <>
            ...
            <Modal
                ...
                onRequestClose={() => { dispatch(updateModal(false)) }}
                transparent={true}>
                <View style={{
                    flex: 1,
...
const LeadAge = () => {
    ...
    return (
        <View style={{ width: 110, height: 30, borderRadius: 15, backgroundColor: "#FF156B", justifyContent: 'center', alignItems: 'center', marginRight: 5, flexDirection: 'row'}}>
